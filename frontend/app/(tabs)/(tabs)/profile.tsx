...
export default function ProfileScreen() {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    statsContainer: { flexDirection: 'row', justifyContent: 'space-around', width: '100%', marginTop: 20, paddingHorizontal: 10 },
    stat: { alignItems: 'center', flex: 1 },
    statNumber: { fontSize: 16, fontWeight: '700', marginBottom: 2, color: colorScheme === 'dark' ? '#fff' : '#000' },
    statLabel: { fontSize: 12, fontWeight: '500', color: colorScheme === 'dark' ? '#8e8e93' : '#8e8e93' },
    bioContainer: { alignItems: 'center', paddingHorizontal: 20, marginTop: 20, marginBottom: 24 },
    nameRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: 6 },
    nameText: { fontSize: 18, fontWeight: '800', letterSpacing: 0.2 },
    pronounBadge: { backgroundColor: colorScheme === 'dark' ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.05)', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 12, marginLeft: 8 },
    pronounText: { fontSize: 11, fontWeight: '600', color: colorScheme === 'dark' ? '#bbb' : '#555' },
    username: { fontSize: 13, fontWeight: '500', color: colorScheme === 'dark' ? '#8e8e93' : '#8e8e93', marginBottom: 10 },
    bioText: { fontSize: 14, textAlign: 'center', color: colorScheme === 'dark' ? '#d1d1d6' : '#333', lineHeight: 20, marginBottom: 14 },
    metadataRow: { flexDirection: 'row', justifyContent: 'center', flexWrap: 'wrap', gap: 12 },
    metadataItem: { flexDirection: 'row', alignItems: 'center', gap: 4 },
    metadataText: { fontSize: 12, fontWeight: '500', color: colorScheme === 'dark' ? '#8e8e93' : '#666' },
    buttonContainer: { flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 20, marginVertical: 10, gap: 10 },
    button: { flex: 1, backgroundColor: colorScheme === 'dark' ? '#1c1c1e' : '#f2f2f7', paddingVertical: 10, borderRadius: 12, alignItems: 'center', borderWidth: 1, borderColor: colorScheme === 'dark' ? '#2c2c2e' : '#e5e5ea' },
    buttonText: { fontWeight: '600', fontSize: 13, color: colorScheme === 'dark' ? '#fff' : '#000' },
    grid: { flex: 1 },
    gridItem: { width: GRID_ITEM_SIZE, height: GRID_ITEM_SIZE, margin: 1 },
    gridImage: { width: '100%', height: '100%' },
    tabContainer: { flexDirection: 'row', paddingHorizontal: 20, marginBottom: 4, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: colorScheme === 'dark' ? '#333' : '#e5e5ea' },
    tab: { flex: 1, paddingVertical: 12, alignItems: 'center' },
    activeTab: { borderBottomWidth: 2, borderBottomColor: colorScheme === 'dark' ? '#fff' : '#000' },
    tabText: { fontSize: 13, fontWeight: '600', color: colorScheme === 'dark' ? '#8e8e93' : '#8e8e93' },
    activeTabText: { color: colorScheme === 'dark' ? '#fff' : '#000', fontWeight: '700' },
    videoIndicator: { position: 'absolute', top: 5, right: 5, backgroundColor: colorScheme === 'dark' ? 'rgba(255,255,255,0.7)' : 'rgba(0,0,0,0.7)', borderRadius: 10, padding: 2 },
    videoIcon: { fontSize: 12, color: colorScheme === 'dark' ? '#000' : '#fff' },
    reelIndicator: { position: 'absolute', top: 5, right: 5, backgroundColor: colorScheme === 'dark' ? 'rgba(255,255,255,0.7)' : 'rgba(0,0,0,0.7)', borderRadius: 10, padding: 2 },
    reelIcon: { fontSize: 12, color: colorScheme === 'dark' ? '#000' : '#fff' },
    emptyContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 20 },
    emptyText: { fontSize: 18, color: colorScheme === 'dark' ? '#ccc' : '#666', textAlign: 'center' },
    headerContentWrapper: { backgroundColor: colorScheme === 'dark' ? '#0a0a0a' : '#fff', borderTopLeftRadius: 30, borderTopRightRadius: 30, marginTop: -24, paddingTop: 12, shadowColor: "#000", shadowOffset: { width: 0, height: -4 }, shadowOpacity: 0.1, shadowRadius: 8, elevation: 5 },
    coverPhotoContainer: { position: 'absolute', top: 0, left: 0, right: 0, height: 160, zIndex: -1 },
    coverPhotoImage: { width: '100%', height: '100%' },
    coverPhotoPlaceholder: { width: '100%', height: '100%', backgroundColor: colorScheme === 'dark' ? '#111' : '#e1e1e1' },
    coverPhotoOverlay: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.1)' },
  }), [colorScheme]);
